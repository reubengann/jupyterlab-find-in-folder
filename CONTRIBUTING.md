...
# Change directory to the jupyterlab_find_in_folder directory
...
folder is located. Then you can remove the symlink named `jupyterlab-find-in-folder` within that folder.
